...
## 2. Affinity Types & Resonance Archetypes

A player’s **Primary Affinity** is their natural "Tuning." This categorization acts as the filter for all future progression and determines the power of your **Hatsu**.
...
## 4. Hybrid Resonance Techniques

Unlocked at **Mastery Level 5** of your Secondary Focus. These represent a harmonic blend of two distinct playstyles.
...
| **Specialist**   | **Anchor**      | **Bastion Grip**     | Redirection of aggressive breeds using niche handling and raw power.    |

---

## 5. Organic Mastery & Breed-Based Leveling

Resonance is not gained through generic points. Instead, **walking specific breeds acts as the catalyst for neural growth** in corresponding categories.

| Dog Category        | Affinity XP    | Representative Breeds                            |
| :------------------ | :------------- | :----------------------------------------------- |
| **The Titans**      | **Anchor**     | Alaskan Malamute, English Mastiff, Saint Bernard |
| **The Spirits**     | **Whisperer**  | Border Collie, Australian Shepherd, Kelpie       |
| **The High-Strung** | **Tactician**  | Shiba Inu, Jack Russell Terrier, Beagle          |
| **The Sprinters**   | **Nomad**      | Greyhound, Siberian Husky, Vizsla                |
| **The Adapters**    | **Urbanist**   | French Bulldog, Pug, Pembroke Welsh Corgi        |
| **The Enigmas**     | **Specialist** | Reactive Rescues, Wolf-Hybrids, Ancient Breeds   |

---

## 6. The Resonance Filter (Skill Potency)
...
## 7. The "Hatsu" (Ultimate Abilities)
